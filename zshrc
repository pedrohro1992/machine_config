...
# VPN ALIAS
alias vpnstart="openvpn3 session-start --config /home/pedro/Workspace/vpn/client.ovpn"
...
alias kgetns='kubectl get namespace | grep -i'
alias kusens='kubectl config set "contexts."`kubectl config current-context`".namespace"'
